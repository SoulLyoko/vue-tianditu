...
`)])])],-1),g=o("",18);function h(m,v,b,_,y,q){const p=a("demo-control"),e=a("code-details");return i(),l("div",null,[k,s(p),s(e,null,{default:u(()=>[d]),_:1}),g])}var M=c(r,[["render",h]]);export{A as __pageData,M as default};
