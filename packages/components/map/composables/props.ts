...
import type { PropTypes, EmitFn, LoadConfig } from "~/types";
...
export const EXTRA_EVENTS = {
  ...
  /** 鹰眼视图控件的开合状态变化时触发事件 */
  viewchange: (e: T.ControlOverviewMapEvent) => e instanceof Object
};

export const mapProps = { ...NATIVE_PROPS, ...EXTRA_PROPS };
export const mapEmits = { ...NATIVE_EVENTS, ...EXTRA_EVENTS };

export type MapProps = PropTypes<typeof mapProps>;
export type MapEmits = typeof mapEmits;
export type MapEmitFn = EmitFn<MapEmits>;
